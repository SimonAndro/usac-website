...
/** didn't we have a minimum page height in fullblue? #702 **/
...
.topbar {
	...
	position: relative;
	height: 48px;
	box-shadow: 0px 0px 15px 2.5px #5998ff;
}
...
.ossn-wall-item .post-contents p {
	/** Incorrect Hyphenation in the theme fullblue 3.0 #824 **/
...
.ossn-wall-container .controls {
	...
	border-left: 1px solid #5998ff;
	border-right: 1px solid #5998ff;
	min-height: 40px;
	width: 100%;
	margin-top: 3px;
	margin-top: -5px;
...
.like-share {
    border-top: 2.5px solid #3e7fe8;
    border-bottom: 2.5px solid #3e7fe8;
    padding: 10px;
    margin-top: 10px;
    background-color: #4f8ef6;
    margin-left: -15px;
...
.sidebar {
	...
	overflow-x: hidden;
	color: #fff;
	box-shadow: 0px 55px 15px 2.5px #5998ff;
}
...
.sidebar-menu-nav li .sub-menu li {
	border: none;
	line-height: 28px;
	border-bottom: 1px solid #3e7fe8;
	margin-left: 0px;
}
...
.ossn-ad-item {
    border-bottom: 2.5px solid #3e7fe8 !important;
...
.ossn-widget {
    ...
    border: 2.5px solid #5998ff;
    box-shadow: 0px 0px 10px 5px #5998ff;
}

.ossn-widget .widget-heading {
    background: #3e7fe8;
    border: 0 solid #5998ff;
    padding: 10px;
    font-weight: bold;
    border-top-left-radius: 5px;
    border-top-right-radius: 5px;
    color: #fff;
    box-shadow: 0px 10px 15px -3px #5998ff;
}
...
.ossn-message-box {
    ...
    border-radius: 3px;
    display: none;
    box-shadow: 0px 0px 5px 1px #5998ff;
}
...
.ossn-users-list-item .col-md-2 img {
    border-radius: 100px;
}
...
.ossn-chat-windows-long {
    ...
    border-left: 1px solid #3e7fe8 !important;
    background: #3e7fe8 !important;
	color: #fff !important;
	top: 48px !important;
    box-shadow: 0px 15px 15px 2.5px #5998ff !important;
}
.ossn-chat-windows-long .inner {
	margin-top: 15px !important;
	text-align: center !important;
    border-top: 1px solid #3e7fe8 !important;
}
.ossn-chat-none {
...
.group-search-items .row {
    border: 1px solid #3e7fe8 !important;
    color: #fff !important;
}
...
.ossn-group-profile .profile-header .header-bottom {
    background: #5998ff !important;
    border-bottom: 2px solid #5998ff !important;
}
.ossn-group-profile .profile-header {
...
.ossn-chat-windows-long .friends-list-item {
    border-top: 1px solid #3e7fe8 !important;
    border-bottom: 1px solid #3e7fe8 !important;
}
...
.profile-edit-layout-right {
    border-left: 1px solid #5998ff !important;
    background: #5998ff !important;
    color: #fff !important;
}
...
.profile-edit-tab-item-active {
    border-left: 3px solid #3e7fe8 !important;
}
.message-box-sent {
    background-color: #4f8ef6  !important;
    box-shadow: 0 0 0px #b2b2b2  !important;
    border-color: #3e7fe8  !important;
}
